...
class X_Meta_Box
{
    ...
    {
        echo '<input type="text" style="width: 95%" value="' . $this->get_field_value($field) . '" id="' . $field['id'] . '" class="code" name="' . $field['id'] . '">';
    }

    private function print_textarea_field($field)
    {
        echo '<textarea style="width: 95%" rows="3" cols="20" id="' . $field['id'] . '" name="' . $field['id'] . '">' . $this->get_field_value($field) . '</textarea>';
    }
